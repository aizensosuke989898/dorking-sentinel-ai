...
import { Key, Eye, EyeOff, AlertTriangle, ExternalLink } from 'lucide-react';
...
interface APIKeySetupProps {
  onKeysSet: (searchKey: string, githubToken: string) => void;
  onSkip: () => void;
}

const APIKeySetup = ({ onKeysSet, onSkip }: APIKeySetupProps) => {
  ...
  const handleSubmit = () => {
    ...
    onKeysSet(searchKey, githubToken);
  };
